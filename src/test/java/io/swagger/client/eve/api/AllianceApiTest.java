...
public class AllianceApiTest {
    ...
    public void getAlliancesTest() throws ApiException {
        ...
        List<Integer> response = api.getAlliances(datasource, ifNoneMatch, userAgent, xUserAgent);
    ...
    public void getAlliancesAllianceIdTest() throws ApiException {
        ...
        String userAgent = null;
        String xUserAgent = null;
        GetAlliancesAllianceIdOk response = api.getAlliancesAllianceId(allianceId, datasource, ifNoneMatch, userAgent, xUserAgent);
    ...
    public void getAlliancesAllianceIdCorporationsTest() throws ApiException {
        ...
        String userAgent = null;
        String xUserAgent = null;
        List<Integer> response = api.getAlliancesAllianceIdCorporations(allianceId, datasource, ifNoneMatch, userAgent, xUserAgent);
    ...
    public void getAlliancesAllianceIdIconsTest() throws ApiException {
        ...
        String userAgent = null;
        String xUserAgent = null;
        GetAlliancesAllianceIdIconsOk response = api.getAlliancesAllianceIdIcons(allianceId, datasource, ifNoneMatch, userAgent, xUserAgent);
    ...
    public void getAlliancesNamesTest() throws ApiException {
        ...
        String userAgent = null;
        String xUserAgent = null;
        List<GetAlliancesNames200Ok> response = api.getAlliancesNames(allianceIds, datasource, ifNoneMatch, userAgent, xUserAgent);
