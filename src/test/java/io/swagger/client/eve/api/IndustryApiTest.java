...
public class IndustryApiTest {
    ...
    public void getCorporationCorporationIdMiningExtractionsTest() throws ApiException {
        ...
        String userAgent = null;
        String xUserAgent = null;
        List<GetCorporationCorporationIdMiningExtractions200Ok> response = api.getCorporationCorporationIdMiningExtractions(corporationId, datasource, page, token, userAgent, xUserAgent);
