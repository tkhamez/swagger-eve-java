...
public class CalendarApi {
    ...
    private com.squareup.okhttp.Call putCharactersCharacterIdCalendarEventIdValidateBeforeCall(Integer characterId, Integer eventId, PutCharactersCharacterIdCalendarEventIdResponse response, String datasource, String token, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = putCharactersCharacterIdCalendarEventIdCall(characterId, eventId, response, datasource, token, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> putCharactersCharacterIdCalendarEventIdWithHttpInfo(Integer characterId, Integer eventId, PutCharactersCharacterIdCalendarEventIdResponse response, String datasource, String token) throws ApiException {
        com.squareup.okhttp.Call call = putCharactersCharacterIdCalendarEventIdValidateBeforeCall(characterId, eventId, response, datasource, token, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call putCharactersCharacterIdCalendarEventIdAsync(Integer characterId, Integer eventId, PutCharactersCharacterIdCalendarEventIdResponse response, String datasource, String token, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = putCharactersCharacterIdCalendarEventIdValidateBeforeCall(characterId, eventId, response, datasource, token, progressListener, progressRequestListener);
