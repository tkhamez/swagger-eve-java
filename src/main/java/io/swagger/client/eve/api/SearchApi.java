...
public class SearchApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSearchCall(List<String> categories, String search, String acceptLanguage, String datasource, String ifNoneMatch, String language, Boolean strict, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getSearchValidateBeforeCall(List<String> categories, String search, String acceptLanguage, String datasource, String ifNoneMatch, String language, Boolean strict, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSearchCall(categories, search, acceptLanguage, datasource, ifNoneMatch, language, strict, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetSearchOk getSearch(List<String> categories, String search, String acceptLanguage, String datasource, String ifNoneMatch, String language, Boolean strict) throws ApiException {
        ApiResponse<GetSearchOk> resp = getSearchWithHttpInfo(categories, search, acceptLanguage, datasource, ifNoneMatch, language, strict);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetSearchOk> getSearchWithHttpInfo(List<String> categories, String search, String acceptLanguage, String datasource, String ifNoneMatch, String language, Boolean strict) throws ApiException {
        com.squareup.okhttp.Call call = getSearchValidateBeforeCall(categories, search, acceptLanguage, datasource, ifNoneMatch, language, strict, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSearchAsync(List<String> categories, String search, String acceptLanguage, String datasource, String ifNoneMatch, String language, Boolean strict, final ApiCallback<GetSearchOk> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSearchValidateBeforeCall(categories, search, acceptLanguage, datasource, ifNoneMatch, language, strict, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetSearchOk>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
