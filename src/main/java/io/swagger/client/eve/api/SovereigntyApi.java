...
public class SovereigntyApi {
     ...
     */
    public com.squareup.okhttp.Call getSovereigntyCampaignsCall(String datasource, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getSovereigntyCampaignsValidateBeforeCall(String datasource, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<GetSovereigntyCampaigns200Ok>> getSovereigntyCampaignsWithHttpInfo(String datasource, String userAgent, String xUserAgent) throws ApiException {
        com.squareup.okhttp.Call call = getSovereigntyCampaignsValidateBeforeCall(datasource, userAgent, xUserAgent, null, null);
    ...
    public com.squareup.okhttp.Call getSovereigntyCampaignsAsync(String datasource, String userAgent, String xUserAgent, final ApiCallback<List<GetSovereigntyCampaigns200Ok>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSovereigntyCampaignsValidateBeforeCall(datasource, userAgent, xUserAgent, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<GetSovereigntyCampaigns200Ok>>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSovereigntyMapCall(String datasource, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSovereigntyMapValidateBeforeCall(String datasource, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<GetSovereigntyMap200Ok>> getSovereigntyMapWithHttpInfo(String datasource, String userAgent, String xUserAgent) throws ApiException {
        com.squareup.okhttp.Call call = getSovereigntyMapValidateBeforeCall(datasource, userAgent, xUserAgent, null, null);
    ...
    public com.squareup.okhttp.Call getSovereigntyMapAsync(String datasource, String userAgent, String xUserAgent, final ApiCallback<List<GetSovereigntyMap200Ok>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSovereigntyMapValidateBeforeCall(datasource, userAgent, xUserAgent, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<GetSovereigntyMap200Ok>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSovereigntyStructuresCall(String datasource, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSovereigntyStructuresValidateBeforeCall(String datasource, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<GetSovereigntyStructures200Ok>> getSovereigntyStructuresWithHttpInfo(String datasource, String userAgent, String xUserAgent) throws ApiException {
        com.squareup.okhttp.Call call = getSovereigntyStructuresValidateBeforeCall(datasource, userAgent, xUserAgent, null, null);
    ...
    public com.squareup.okhttp.Call getSovereigntyStructuresAsync(String datasource, String userAgent, String xUserAgent, final ApiCallback<List<GetSovereigntyStructures200Ok>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSovereigntyStructuresValidateBeforeCall(datasource, userAgent, xUserAgent, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<GetSovereigntyStructures200Ok>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
