...
public class GetCorporationsCorporationIdOrders200Ok {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(duration, escrow, isBuyOrder, issued, locationId, minVolume, orderId, price, range, regionId, typeId, volumeRemain, volumeTotal, walletDivision);
  }
