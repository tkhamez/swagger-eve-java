...
public class GetCorporationsCorporationIdOrders200Ok {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(orderId, typeId, regionId, locationId, range, price, volumeTotal, volumeRemain, issued, isBuyOrder, minVolume, escrow, duration, walletDivision);
  }
