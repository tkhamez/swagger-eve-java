...
```xml
<dependency>
    <groupId>io.swagger.client.eve</groupId>
...
```groovy
compile "io.swagger.client.eve:swagger-java-client:0.7.5.1"
```
...
* target/swagger-java-client-0.7.5.1.jar
* target/lib/*.jar
...
import io.swagger.client.eve.*;
import io.swagger.client.eve.auth.*;
import io.swagger.client.eve.model.*;
import io.swagger.client.eve.api.AllianceApi;
